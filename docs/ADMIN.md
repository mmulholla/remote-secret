...
| --vault-aprrole-secret-name                          | VAULTAPPROLESECRETNAME         | vault-approle-remote-secret-operator | Secret name in k8s namespace with approle credentials. Used with Vault approle authentication. Secret should contain 'role_id' and 'secret_id' keys.                                                                   |
